...
class LogReaderGetCommand extends Command
{
    ...
    protected function getOptions()
    {
        return [
            ...
            ['level', null, InputOption::VALUE_OPTIONAL, 'Filter by level.', null],
            ['with-read', 'r', InputOption::VALUE_NONE, 'Include log entries that marked as read in request.'],
            ['order-by', null, InputOption::VALUE_OPTIONAL, 'Order by information.', 'date'],
            ['order-direction', null, InputOption::VALUE_OPTIONAL, 'Order by direction.', 'asc'],
            ['paginate', 'p', InputOption::VALUE_NONE, 'Paging the result.'],
            ['per-page', null, InputOption::VALUE_OPTIONAL, 'The number of log entries that you want to get per page.', 10],
            ['page', null, InputOption::VALUE_OPTIONAL, 'The page that you want to display from paging.', 1],
        ];
    }
}
